...
@section('title', __('shipping_company::dashboard.shipping_companies.routes.create'))
@section('content')
  ...
  <div class="page-content">
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">{{ __('shipping_company::dashboard.shipping_companies.routes.create') }}</a>
        </li>
      </ul>
    </div>
    ...
    <div class="row">
      <form id="form"
        ...
        action="{{ route('dashboard.shipping_companies.store') }}">
        @csrf
        <div class="col-md-12">
          ...
          <div class="col-md-9">
            <div class="tab-content">
              ...
              <div class="tab-pane active fade in"
                id="global_setting">
                <h3 class="page-title">{{
                  __('shipping_company::dashboard.shipping_companies.form.tabs.general') }}</h3>
                <div class="col-md-10">
                    ...
                    <div id="first_{{ $code }}"
                      ...
                      <div class="form-group">
                        <label class="col-md-2">
                          {{ __('shipping_company::dashboard.shipping_companies.form.name')
                          }} - {{ $code }}
                        </label>
                        <div class="col-md-9">
                          <input type="text"
                      ...
                      <div class="form-group">
                        <label class="col-md-2">
                          {{ __('shipping_company::dashboard.shipping_companies.form.address')
                          }} - {{ $code }}
                        </label>
                        <div class="col-md-9">
                          <input type="text"
                  ...
                  <div class="form-group">
                    <label class="col-md-2">
                      {{ __('shipping_company::dashboard.shipping_companies.form.status') }}
                    </label>
                    <div class="col-md-9">
                      <input type="checkbox"
                        checked
